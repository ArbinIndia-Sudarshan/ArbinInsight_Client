    ...
    <header className="rounded-[18px] border border-slate-200 bg-white p-4 shadow-lg shadow-slate-200/60 sm:p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <img src={ArbinLogo} width={56} height={56} alt="Arbin logo" className="h-14 w-14 rounded-2xl bg-slate-100 object-contain" />
          <div>
            <h1 className="text-xl font-semibold text-slate-900 sm:text-2xl">ArbinInsight Client</h1>
